...
Public Class EWrapperImpl
    ...
    'Public Event on_current_time(Ewrapper_impl_time As EWrapperImpl, eventArgs As on_current_time_event)
    Public Shared Event on_current_time(ByVal time As Long)
    Public Shared Event on_price_return(ByVal tickerId, ByVal field, ByVal price, ByVal canAutoExecute)
    Public Shared Event on_size_return(ByVal tickerId, ByVal field, ByVal size)
    Public Shared Event on_string_return(ByVal tickerId, ByVal field, ByVal string_return)
    Public Shared Event on_open_ords(ByVal orderId As Integer, ByVal contract As IBApi.Contract, ByVal order As IBApi.Order, ByVal orderState As IBApi.OrderState)
    Public Shared Event on_open_ords_end()
    Public Shared Event on_ords_status(ByVal orderId As Integer, ByVal status As String, ByVal filled As Double, ByVal remaining As Double, ByVal avgFillPrice As Double,
    ...
    Public Shared Event on_exec_details(ByVal reqId As Integer, ByVal contract As IBApi.Contract, ByVal execution As IBApi.Execution)
    Public Shared Event on_cmssn_rpt(ByVal commissionReport As IBApi.CommissionReport)
    Public Shared Event on_next_valid_id_return(ByVal next_order_ID As Integer)
    ...
    Public Sub commissionReport(commissionReport As IBApi.CommissionReport) Implements IBApi.EWrapper.commissionReport
        ...
        RaiseEvent on_cmssn_rpt(commissionReport)
    ...
    Public Sub currentTime(time As Long) Implements IBApi.EWrapper.currentTime
        ...
        'RaiseEvent on_current_time(Me, New on_current_time_event With {.time = time})
        RaiseEvent on_current_time(time)
    ...
    Public Sub [error](id As Integer, errorCode As Integer, errorMsg As String) Implements IBApi.EWrapper.error
        ...
        If errorCode = 2106 Or errorCode = 2104 Or errorCode = 399 Then
        Else
    ...
    Public Sub execDetails(reqId As Integer, contract As IBApi.Contract, execution As IBApi.Execution) Implements IBApi.EWrapper.execDetails
        ...
        RaiseEvent on_exec_details(reqId, contract, execution)
    ...
    Public Sub nextValidId(orderId As Integer) Implements IBApi.EWrapper.nextValidId
        ...
        If Connect.bool = True Then

            RaiseEvent on_next_valid_id_return(nextOrderId)
    ...
    Public Sub openOrder(orderId As Integer, contract As IBApi.Contract, order As IBApi.Order, orderState As IBApi.OrderState) Implements IBApi.EWrapper.openOrder
        ...
        RaiseEvent on_open_ords(orderId, contract, order, orderState)
    ...
    Public Sub orderStatus(orderId As Integer, status As String, filled As Double, remaining As Double, avgFillPrice As Double, permId As Integer, parentId As Integer, lastFillPrice As Double, clientId As Integer, whyHeld As String) Implements IBApi.EWrapper.orderStatus
        ...
        RaiseEvent on_ords_status(orderId, status, filled, remaining, avgFillPrice, permId, parentId, lastFillPrice, clientId, whyHeld)
    ...
    Public Sub tickPrice(tickerId As Integer, field As Integer, price As Double, canAutoExecute As Integer) Implements IBApi.EWrapper.tickPrice
        ...
        RaiseEvent on_price_return(tickerId, field, price, canAutoExecute)
    ...
    Public Sub tickString(tickerId As Integer, field As Integer, string_return As String) Implements IBApi.EWrapper.tickString
        ...
        RaiseEvent on_string_return(tickerId, field, string_return)
